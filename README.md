...
伺服器將在 `http://127.0.0.1:3322` 上啟動。

### 4. **使用說明**

1. 開啟瀏覽器，進入 `http://127.0.0.1:3322`
...
2. **本地監聽**：Flask 伺服器僅綁定至 `127.0.0.1:3322`
...
**Q: RSS 訂閱如何使用？**
A: 將 `http://127.0.0.1:3322/money/rss` 或 `http://127.0.0.1:3322/global/rss` 加入您的 RSS 閱讀器即可。
